...
const FAQ = () => {
  const accordionItems = [
    ...
    },
    {
      ...
      answer:
        "Currently, I accept Blue Cross Blue Shield, Harvard Pilgrim, United Healthcare, Tufts, Medicare, and Optum insurance plans. For other insurance providers, I am considered out-of-network. However, many clients utilize their out-of-network benefits and may receive partial reimbursement for therapy costs. I can provide the necessary documentation for you to submit to your insurance company for reimbursement. It is advisable to contact your insurance provider directly to inquire about your outpatient, out-of-network, mental health benefits.<br/><br/><span class='quote'>A Word of Caution About Using Insurance:</span><br/><br/>Utilizing insurance for therapy may involve limitations on the number of covered sessions and requests for therapy notes by the insurance company. Additionally, opting for out-of-network benefits may require a mental health diagnosis, potentially affecting your medical records. I believe therapy should be accessible without necessitating a permanent diagnosis. Your mental well-being is essential, and I strive to provide quality care while respecting your privacy.",
      expanded: false,
    },
    {
      id: "faq6",
